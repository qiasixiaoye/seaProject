...
def run(
    ...
    result: dict[str, Any] = {
        ...
        "retrieval_routes": final_state.get("retrieval_routes", []),
        "multimodal_candidates": final_state.get("multimodal_candidates", []),
        "input_mode": "multimodal" if str(image_ref or "").strip() else "text",
        "elapsed_ms": elapsed_ms,
        "token_usage": token_usage,
        "llm_configured": llm.configured(),
    }
